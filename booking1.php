...
if(!isset($_SESSION['user']))
{
	...
	$qry2=mysqli_query($con,"select * from tbl_events where movie_id='".$_SESSION['movie']."'");
					...
					<div class="about span_1_of_2">	
						<h3><?php echo $movie['movie_name']; ?></h3>	
							...
							<div class="col-md-12 text-center" style="padding-bottom:20px">
								...
								<a href="booking1.php?date=<?php echo date('Y-m-d',strtotime($date . "+1 days"));?>"><button class="btn btn-default"><i class="glyphicon glyphicon-chevron-right"></i></button></a>
								<?php }
								...
								?>
									...
									<tr>
										...
										<td>
											<form  action="process_booking1.php" method="post">
