<?php include('header.php');
	$qry2=mysqli_query($con,"select * from tbl_events where movie_id='".$_GET['id']."'");
					...
					<div class="about span_1_of_2">	
						<h3 style="color:#444; font-size:23px;" class="text-center"><?php echo $movie['movie_name']; ?></h3>	
							...
							<table class="table table-hover table-bordered text-center">
								...
								<thead>
										<tr>
											<th class="text-center" style="font-size:16px;"><b>Venue</b></th>
									...
									<tr>
										...
										<td>
											...
											while($shh=mysqli_fetch_array($tr))
											{
												...
												<a href="check_login1.php?show=<?php echo $shh['s_id'];?>&movie=<?php echo $shh['movie_id'];?>&theatre=<?php echo $shw['theatre_id'];?>"><button class="btn btn-default"><?php echo date('h:i A',strtotime($ttme['start_time']));?></button></a>
												<?php
											}
											?>
										</td>
