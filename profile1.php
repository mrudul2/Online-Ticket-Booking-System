		...
		<div class="content-top">
				...
				if(mysqli_num_rows($bk))
				{
					...
					<table class="table table-bordered">
						...
						{
							$e=mysqli_query($con,"select * from tbl_events where movie_id=(select movie_id from tbl_shows where s_id='".$bkg['show_id']."')");
							$eve=mysqli_fetch_array($e);
